...
public class ServiceServiceImpl implements IServiceService {
    ...
    @Override
    public Page<com.example.demo.model.Service> findByAll(Pageable pageable, String serviceNameSearch, String attachServiceIdSearch) {
        return serviceRepository.search("%" + serviceNameSearch + "%", "%" + attachServiceIdSearch + "%", pageable);
    }
    ...
    @Override
    public Optional<com.example.demo.model.Service> findById(int service_id) {
